...
func (u *ALUImpl) runDS(state utils.InstEmuState) {
	inst := state.Inst()
	switch inst.Opcode {
	case 13:
...
func (u *ALUImpl) runDSWRITEB32(state utils.InstEmuState) {
	inst := state.Inst()
	sp := state.Scratchpad()
	layout := sp.AsDS()
	lds := u.LDS()
...
func (u *ALUImpl) runDSWRITE2B32(state utils.InstEmuState) {
	inst := state.Inst()
	sp := state.Scratchpad()
	layout := sp.AsDS()
	lds := u.LDS()
...
func (u *ALUImpl) runDSREADB32(state utils.InstEmuState) {
	inst := state.Inst()
	sp := state.Scratchpad()
	layout := sp.AsDS()
	lds := u.LDS()
...
func (u *ALUImpl) runDSREAD2B32(state utils.InstEmuState) {
	inst := state.Inst()
	sp := state.Scratchpad()
	layout := sp.AsDS()
	lds := u.LDS()
...
func (u *ALUImpl) runDSWRITE2B64(state utils.InstEmuState) {
	inst := state.Inst()
	sp := state.Scratchpad()
	layout := sp.AsDS()
	lds := u.LDS()
...
func (u *ALUImpl) runDSREADB64(state utils.InstEmuState) {
	sp := state.Scratchpad()
	layout := sp.AsDS()
	lds := u.LDS()
...
func (u *ALUImpl) runDSREAD2B64(state utils.InstEmuState) {
	inst := state.Inst()
	sp := state.Scratchpad()
	layout := sp.AsDS()
	lds := u.LDS()
