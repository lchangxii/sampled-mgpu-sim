...
func (u *ALUImpl) runVOP3B(state utils.InstEmuState) {
	inst := state.Inst()
...
func (u *ALUImpl) runVADDU32VOP3b(state utils.InstEmuState) {
...
func (u *ALUImpl) runVSUBU32VOP3b(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP3B()
...
func (u *ALUImpl) runVSUBREVU32VOP3b(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP3B()
...
func (u *ALUImpl) runVADDCU32VOP3b(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP3B()
...
func (u *ALUImpl) runVSUBBU32VOP3b(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP3B()
...
func (u *ALUImpl) runVSUBBREVU32VOP3b(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP3B()
...
func (u *ALUImpl) runVDIVSCALEF64(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP3B()
	var i uint
	for i = 0; i < 64; i++ {
		if !laneMasked(sp.EXEC, i) {
