...
func (u *ALUImpl) runVOP1(state utils.InstEmuState) {
	inst := state.Inst()
	switch inst.Opcode {
	case 1:
		u.runVMOVB32(state)
...
func (u *ALUImpl) runVMOVB32(state utils.InstEmuState) {
...
func (u *ALUImpl) runVREADFIRSTLANEB32(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP1()
	var i uint
	var laneid uint
	for i = 0; i < 64; i++ {
...
func (u *ALUImpl) runVCVTF64I32(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP1()
...
func (u *ALUImpl) runVCVTF32I32(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP1()
...
func (u *ALUImpl) runVCVTF32U32(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP1()
...
func (u *ALUImpl) runVCVTU32F32(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP1()
...
func (u *ALUImpl) runVCVTI32F32(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP1()
	var i uint
	for i = 0; i < 64; i++ {
		if !laneMasked(sp.EXEC, i) {
...
func (u *ALUImpl) runTRUNKF32(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP1()
	for i := uint(0); i < 64; i++ {
		if !laneMasked(sp.EXEC, i) {
			continue
...
func (u *ALUImpl) runRNDNEF32(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP1()
	for i := uint(0); i < 64; i++ {
		if !laneMasked(sp.EXEC, i) {
			continue
...
func (u *ALUImpl) runEXPF32(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP1()
	for i := uint(0); i < 64; i++ {
		if !laneMasked(sp.EXEC, i) {
			continue
...
func (u *ALUImpl) runLOGF32(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP1()
	for i := uint(0); i < 64; i++ {
		if !laneMasked(sp.EXEC, i) {
			continue
...
func (u *ALUImpl) runVRSQF32(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP1()
...
func (u *ALUImpl) runVRCPIFLAGF32(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP1()
...
func (u *ALUImpl) runVNOTB32(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP1()
...
func (u *ALUImpl) runBFREVB32(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP1()
...
func (u *ALUImpl) runVCVTF32UBYTE0(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP1()
	var i uint
	for i = 0; i < 64; i++ {
		if !laneMasked(sp.EXEC, i) {
...
func (u *ALUImpl) runVCVTF64F32(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP1()
	var i uint
	for i = 0; i < 64; i++ {
		if !laneMasked(sp.EXEC, i) {
...
func (u *ALUImpl) runVRCPF64(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP1()
	var i uint
	for i = 0; i < 64; i++ {
		if !laneMasked(sp.EXEC, i) {
...
func (u *ALUImpl) runVSQRTF32(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP1()
	var i uint
	for i = 0; i < 64; i++ {
		if !laneMasked(sp.EXEC, i) {
...
func (u *ALUImpl) runVCVTF32F64(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP1()
	var i uint
	for i = 0; i < 64; i++ {
		if !laneMasked(sp.EXEC, i) {
...
func (u *ALUImpl) runVCVTF16F32(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP1()
	var i uint
	for i = 0; i < 64; i++ {
		if !laneMasked(sp.EXEC, i) {
...
func (u *ALUImpl) runLogLegacyF32(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP1()
