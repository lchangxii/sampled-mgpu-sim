...
func (u *ALUImpl) runVOP3A(state utils.InstEmuState) {
	inst := state.Inst()
...
func (u *ALUImpl) vop3aPreprocess(state utils.InstEmuState) {
	inst := state.Inst()
...
func (u *ALUImpl) vop3aPreProcessAbs(state utils.InstEmuState) {
	inst := state.Inst()
...
func (u *ALUImpl) vop3aPreProcessNeg(state utils.InstEmuState) {
	inst := state.Inst()
...
func (u *ALUImpl) vop3aPreProcessF64Neg(state utils.InstEmuState) {
	inst := state.Inst()
	sp := state.Scratchpad().AsVOP3A()
...
func (u *ALUImpl) vop3aPreProcessF32Neg(state utils.InstEmuState) {
	inst := state.Inst()
	sp := state.Scratchpad().AsVOP3A()
	if inst.Neg&0x1 != 0 {
		for i := 0; i < 64; i++ {
...
func (u *ALUImpl) vop3aPreProcessB32Neg(state utils.InstEmuState) {
	inst := state.Inst()
	sp := state.Scratchpad().AsVOP3A()
	if inst.Neg&0x1 != 0 {
		for i := 0; i < 64; i++ {
...
func (u *ALUImpl) vop3aPostprocess(state utils.InstEmuState) {
	inst := state.Inst()
...
func (u *ALUImpl) runVCmpLtF32VOP3a(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP3A()
	// sp.VCC = 0
	var i uint
...
func (u *ALUImpl) runVCmpGtF32VOP3a(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP3A()
	// sp.VCC = 0
	var i uint
	var src0, src1 float32
...
func (u *ALUImpl) runVCmpNltF32VOP3a(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP3A()
	// sp.VCC = 0
	var i uint
	var src0, src1 float32
...
func (u *ALUImpl) runVCmpLtI32VOP3a(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP3A()
...
func (u *ALUImpl) runVCmpLeI32VOP3a(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP3A()
...
func (u *ALUImpl) runVCmpGtI32VOP3a(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP3A()
...
func (u *ALUImpl) runVCmpGEI32VOP3a(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP3A()
...
func (u *ALUImpl) runVCmpLtU32VOP3a(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP3A()
...
func (u *ALUImpl) runVCmpEqU32VOP3a(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP3A()
...
func (u *ALUImpl) runVCmpLeU32VOP3a(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP3A()
...
func (u *ALUImpl) runVCmpGtU32VOP3a(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP3A()
...
func (u *ALUImpl) runVCmpLgU32VOP3a(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP3A()
...
func (u *ALUImpl) runVCmpGeU32VOP3a(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP3A()
...
func (u *ALUImpl) runVCmpLtU64VOP3a(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP3A()
...
func (u *ALUImpl) runVCNDMASKB32VOP3a(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP3A()
...
func (u *ALUImpl) runVSUBF32VOP3a(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP3A()
...
func (u *ALUImpl) runVMADF32(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP3A()
...
func (u *ALUImpl) runVMADI32I24(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP3A()
...
func (u *ALUImpl) runVMADU64U32(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP3A()
...
func (u *ALUImpl) runVMULLOU32(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP3A()
...
func (u *ALUImpl) runVMULHIU32(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP3A()
...
func (u *ALUImpl) runVLSHLREVB64(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP3A()
...
func (u *ALUImpl) runVASHRREVI64(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP3A()
...
func (u *ALUImpl) runVADDF64(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP3A()
	inst := state.Inst()
...
func (u *ALUImpl) runVFMAF64(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP3A()
	inst := state.Inst()
	if inst.IsSdwa == false {
		var i uint
...
func (u *ALUImpl) runVMIN3F32(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP3A()
	inst := state.Inst()
	if inst.IsSdwa == false {
		var i uint
...
func (u *ALUImpl) runVMIN3I32(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP3A()
	inst := state.Inst()
	if inst.IsSdwa == false {
		var i uint
...
func (u *ALUImpl) runVMIN3U32(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP3A()
	inst := state.Inst()
	if inst.IsSdwa == false {
		var i uint
...
func (u *ALUImpl) runVMAX3F32(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP3A()
	inst := state.Inst()
	if inst.IsSdwa == false {
		var i uint
...
func (u *ALUImpl) runVMAX3I32(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP3A()
	inst := state.Inst()
	if inst.IsSdwa == false {
		var i uint
...
func (u *ALUImpl) runVMAX3U32(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP3A()
	inst := state.Inst()
	if inst.IsSdwa == false {
		var i uint
...
func (u *ALUImpl) runVMED3F32(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP3A()
	inst := state.Inst()
	if inst.IsSdwa == false {
		var i uint
...
func (u *ALUImpl) runVMED3I32(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP3A()
	inst := state.Inst()
	if inst.IsSdwa == false {
		var i uint
...
func (u *ALUImpl) runVMED3U32(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP3A()
	inst := state.Inst()
	if inst.IsSdwa == false {
		var i uint
...
func (u *ALUImpl) runVMULF64(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP3A()
	inst := state.Inst()
	if inst.IsSdwa == false {
		var i uint
...
func (u *ALUImpl) runVDIVFMASF64(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP3A()
	inst := state.Inst()
...
func (u *ALUImpl) runVDIVFIXUPF64(state utils.InstEmuState) {
	sp := state.Scratchpad().AsVOP3A()
	inst := state.Inst()
