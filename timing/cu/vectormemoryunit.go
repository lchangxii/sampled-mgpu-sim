...
//        if info.Wavefront.CollectWfMem {
//            mem_footprint := &kernels.MemFootprint {
//                Address : info.Read.Address,
//                DataSize : info.Read.AccessByteSize,
//                MemType : kernels.VecRead,
//            }
//            info.Wavefront.AddMemFootprint(mem_footprint)
//        }
	} else {
		req = info.Write
//        if info.Wavefront.CollectWfMem {
...
//                DataSize : uint64(len(info.Write.Data)),
//                MemType : kernels.VecWrite,
//            }
//            info.Wavefront.AddMemFootprint(mem_footprint)
//        }
