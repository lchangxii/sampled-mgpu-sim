...
def run_vgg19(benchmarks):
    ...
    benchparams.append( ("conv2d", conv2d_2_3) )
    ...
    benchparams.append( ("conv2d", conv2d_3_3) )
    ...
    benchparams.append( ("conv2d", conv2d_4_3) )
