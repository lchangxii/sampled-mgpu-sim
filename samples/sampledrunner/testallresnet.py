...
if args.bench=="resnet50":
    ...
    conv2d_2_3_1 = conv2ds[4]
    conv2d_2_3_2 = conv2ds[5]
    conv2d_2_3_3 = conv2ds[6]
####################################
    ...
    conv2d_3_3_1 = conv2ds[11]
    conv2d_3_3_2 = conv2ds[12]
    conv2d_3_3_3 = conv2ds[13]
    conv2d_3_4_1 = conv2ds[11]
    conv2d_3_4_2 = conv2ds[12]
    conv2d_3_4_3 = conv2ds[13]
################################
    ...
    conv2d_4_3_1 = conv2ds[18]
    conv2d_4_3_2 = conv2ds[19]
    conv2d_4_3_3 = conv2ds[20]
    conv2d_4_4_1 = conv2ds[18]
    conv2d_4_4_2 = conv2ds[19]
    conv2d_4_4_3 = conv2ds[20]
    conv2d_4_5_1 = conv2ds[18]
    conv2d_4_5_2 = conv2ds[19]
    conv2d_4_5_3 = conv2ds[20]
    conv2d_4_6_1 = conv2ds[18]
    conv2d_4_6_2 = conv2ds[19]
    conv2d_4_6_3 = conv2ds[20]
################################
    ...
    conv2d_5_3_1 = conv2ds[25]
    conv2d_5_3_2 = conv2ds[26]
    conv2d_5_3_3 = conv2ds[27]
    ...
    benchparams.append( ("conv2d", conv2d_2_3_1) )
    benchparams.append( ("conv2d", conv2d_2_3_2) )
    benchparams.append( ("conv2d", conv2d_2_3_3) )
    ...
    benchparams.append( ("conv2d", conv2d_3_3_1) )
    benchparams.append( ("conv2d", conv2d_3_3_2) )
    benchparams.append( ("conv2d", conv2d_3_3_3) )
    benchparams.append( ("conv2d", conv2d_3_4_1) )
    benchparams.append( ("conv2d", conv2d_3_4_2) )
    benchparams.append( ("conv2d", conv2d_3_4_3) )
    ...
    benchparams.append( ("conv2d", conv2d_4_3_1) )
    benchparams.append( ("conv2d", conv2d_4_3_2) )
    benchparams.append( ("conv2d", conv2d_4_3_3) )
    benchparams.append( ("conv2d", conv2d_4_4_1) )
    benchparams.append( ("conv2d", conv2d_4_4_2) )
    benchparams.append( ("conv2d", conv2d_4_4_3) )
    benchparams.append( ("conv2d", conv2d_4_5_1) )
    benchparams.append( ("conv2d", conv2d_4_5_2) )
    benchparams.append( ("conv2d", conv2d_4_5_3) )
    benchparams.append( ("conv2d", conv2d_4_6_1) )
    benchparams.append( ("conv2d", conv2d_4_6_2) )
    benchparams.append( ("conv2d", conv2d_4_6_3) )
    ...
    benchparams.append( ("conv2d", conv2d_5_3_1) )
    benchparams.append( ("conv2d", conv2d_5_3_2) )
    benchparams.append( ("conv2d", conv2d_5_3_3) )
