...
// MI100PlatformBuilder can build a platform that equips R9Nano GPU.
type MI100PlatformBuilder struct {
...
func MakeMI100Builder() MI100PlatformBuilder {
...
func (b MI100PlatformBuilder) WithParallelEngine() MI100PlatformBuilder {
	b.useParallelEngine = true
	return b
}

// WithISADebugging enables ISA debugging in the simulation.
func (b MI100PlatformBuilder) WithISADebugging() MI100PlatformBuilder {
	b.debugISA = true
	return b
}

// WithVisTracing lets the platform to record traces for visualization purposes.
func (b MI100PlatformBuilder) WithVisTracing() MI100PlatformBuilder {
	b.traceVis = true
...
// time.
func (b MI100PlatformBuilder) WithPartialVisTracing(
...
func (b MI100PlatformBuilder) WithMemTracing() MI100PlatformBuilder {
	b.traceMem = true
	return b
}

// WithNumGPU sets the number of GPUs to build.
func (b MI100PlatformBuilder) WithNumGPU(n int) MI100PlatformBuilder {
	b.numGPU = n
	return b
}

// WithLog2PageSize sets the page size as a power of 2.
func (b MI100PlatformBuilder) WithLog2PageSize(
	n uint64,
) MI100PlatformBuilder {
	b.log2PageSize = n
	return b
...
func (b MI100PlatformBuilder) WithMonitor(
...
func (b MI100PlatformBuilder) WithBufferAnalyzer(
	traceDirName string,
	tracePeriod float64,
) MI100PlatformBuilder {
...
func (b MI100PlatformBuilder) WithMagicMemoryCopy() MI100PlatformBuilder {
	b.useMagicMemoryCopy = true
	return b
}

// Build builds a platform with R9Nano GPUs.
func (b MI100PlatformBuilder) Build() *Platform {
	...
	b.globalStorage = mem.NewStorage(uint64(1+b.numGPU) * 32 * mem.GB)
...
func (b MI100PlatformBuilder) buildGPUDriver(
...
func (b *MI100PlatformBuilder) setupVisTracing() {
	if !b.traceVis {
		return
	}
...
func (b *MI100PlatformBuilder) setupBufferLevelTracing() {
...
func (b *MI100PlatformBuilder) createGPUs(
	rootComplexID int,
	pcieConnector *pcie.Connector,
	gpuBuilder MI100GPUBuilder,
...
func (b MI100PlatformBuilder) createPMCPageTable() *mem.BankedLowModuleFinder {
...
func (b MI100PlatformBuilder) createRDMAAddrTable() *mem.BankedLowModuleFinder {
...
func (b MI100PlatformBuilder) createConnection(
	engine sim.Engine,
	gpuDriver *driver.Driver,
...
func (b MI100PlatformBuilder) createEngine() sim.Engine {
...
func (b MI100PlatformBuilder) createMMU(
	engine sim.Engine,
...
func (b *MI100PlatformBuilder) createGPUBuilder(
	engine sim.Engine,
	gpuDriver *driver.Driver,
	mmuComponent *mmu.MMU,
) MI100GPUBuilder {
	gpuBuilder := MakeMI100GPUBuilder().
		WithEngine(engine).
...
func (b *MI100PlatformBuilder) setISADebugger(
	gpuBuilder MI100GPUBuilder,
) MI100GPUBuilder {
	if !b.debugISA {
		return gpuBuilder
...
func (b *MI100PlatformBuilder) setMemTracer(
	gpuBuilder MI100GPUBuilder,
) MI100GPUBuilder {
	if !b.traceMem {
		return gpuBuilder
...
func (b *MI100PlatformBuilder) createGPU(
	index int,
	gpuBuilder MI100GPUBuilder,
	gpuDriver *driver.Driver,
	rdmaAddressTable *mem.BankedLowModuleFinder,
	...
	memAddrOffset := uint64(index) * 32 * mem.GB
    fmt.Printf("offset %d\n",memAddrOffset)
	gpu := gpuBuilder.
...
func (b *MI100PlatformBuilder) configRDMAEngine(
	gpu *GPU,
...
func (b *MI100PlatformBuilder) configPMC(
	gpu *GPU,
	gpuDriver *driver.Driver,
	addrTable *mem.BankedLowModuleFinder,
) {
