...
func (b EmuBuilder) Build() *Platform {
    ...
    emu.CreateUniqSampledComputeUnit( "cu",gpuBuilder.freq, disassembler,pageTable,b.log2PageSize, storage,nil )
    emu.CreateUniqBBVComputeUnit( "cu",gpuBuilder.freq, disassembler,pageTable,b.log2PageSize, storage,nil )
    emu.CreateUniqStaticComputeUnit( "cu",gpuBuilder.freq, disassembler,pageTable,b.log2PageSize, storage,nil )
